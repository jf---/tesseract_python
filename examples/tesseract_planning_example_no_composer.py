...
interpolated_results_instruction = generateInterpolatedProgram(
    results_instruction, cur_state, t_env, 3.14, 1.0, 3.14, 10
)
...
ProfileDictionary_addProfile_TrajOptPlanProfile(
    trajopt_profiles, TRAJOPT_DEFAULT_NAMESPACE, "TEST_PROFILE", trajopt_plan_profile
)
ProfileDictionary_addProfile_TrajOptCompositeProfile(
    trajopt_profiles,
